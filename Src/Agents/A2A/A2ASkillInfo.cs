...
/// <summary>
/// opt-in metadata attached to a FastEndpoints endpoint so the <c>FastEndpoints.A2A</c> addon
/// exposes it as an A2A (agent-to-agent) skill. pushed onto the endpoint's public
