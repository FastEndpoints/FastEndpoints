...
static class AgentPublishedNameResolver
{
    ...
    internal static string Resolve(EndpointDefinition def, string? explicitValue, string valueLabel, string pluralValueLabel)
    {
    ...
    static string ValidateExplicit(Type endpointType, string value, string valueLabel, string pluralValueLabel)
    {
        if (!IsValid(value))
            throw new InvalidOperationException(
