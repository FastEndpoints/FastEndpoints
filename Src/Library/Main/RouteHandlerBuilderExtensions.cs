...
{
    extension(RouteHandlerBuilder hb)
    {
        /// <summary>
        ...
        public RouteHandlerBuilder ProducesProblemFE<TResponse>(int statusCode = 400, string contentType = "application/problem+json")
        ...
        /// <param name="statusCode">the status code of the error response</param>
        /// <param name="contentType">content type header value</param>
        public RouteHandlerBuilder ProducesProblemFE(int statusCode = 400, string contentType = "application/problem+json")
        ...
        /// <param name="statusCode">the status code of the error response</param>
        /// <param name="contentType">content type header value</param>
        public RouteHandlerBuilder ProducesProblemDetails(int statusCode = 400, string contentType = "application/problem+json")
            => hb.ProducesProblemFE<ProblemDetails>(statusCode, contentType);

        /// <summary>
        /// clears just the default "accepts metadata" from the endpoint.
        /// </summary>
        public RouteHandlerBuilder ClearDefaultAccepts()
        {
            hb.Add(
                epBuilder =>
                {
        ...
        public RouteHandlerBuilder ClearDefaultProduces(params int[] statusCodes)
        {
            hb.Finally(
                eb =>
                {
        ...
        public RouteHandlerBuilder Accepts<TRequest>() where TRequest : notnull
        {
