    ...
    where TStorageProvider : class, IEventHubStorageProvider<TStorageRecord>
{
    ...
    public GrpcServiceEndpointConventionBuilder Register<TCommand, THandler, TResult>()
        ...
        where TResult : class
        => _routeBuilder.MapGrpcService<UnaryHandlerExecutor<TCommand, THandler, TResult>>().EnableGrpcWeb();
    ...
    public GrpcServiceEndpointConventionBuilder RegisterServerStream<TCommand, THandler, TResult>()
        ...
        where TResult : class
        => _routeBuilder.MapGrpcService<ServerStreamHandlerExecutor<TCommand, THandler, TResult>>().EnableGrpcWeb();
    ...
    public GrpcServiceEndpointConventionBuilder RegisterClientStream<T, THandler, TResult>()
        ...
        where TResult : class
        => _routeBuilder.MapGrpcService<ClientStreamHandlerExecutor<T, THandler, TResult>>().EnableGrpcWeb();
        ...
        where TEvent : class, IEvent
    {
        ...
        return _routeBuilder.MapGrpcService<EventHub<TEvent, TStorageRecord, TStorageProvider>>().EnableGrpcWeb();
    }
}